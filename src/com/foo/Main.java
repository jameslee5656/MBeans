...
//	        System.out.println("ArrayIndexOutOfBoundsException caught");
		...
		if ((mission.equals("help")) || (mission.equals("h"))) {
			...
			System.out.println("|    2.1 all  (a) : Every parts                                |");
			System.out.println("|      (also any form of M,R,O,T will be all too)              |");
			System.out.println("|    2.2 M    (m) : Memory                                     |");
			System.out.println("|    2.3 R    (r) : RunTime                                    |");
			System.out.println("|    2.4 O    (o) : Operating System                           |");
			System.out.println("|    2.5 T    (t) : Threading                                  |");
...
//			System.out.println("**");
		...
		System.out.println(mission + "  " + host+ "   " + port);
